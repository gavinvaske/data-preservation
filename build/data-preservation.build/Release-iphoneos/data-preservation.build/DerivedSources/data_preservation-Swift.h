...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="data_preservation",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC17data_preservation11AppDelegate")
...
SWIFT_CLASS("_TtC17data_preservation13SceneDelegate")
